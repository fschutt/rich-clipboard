...
//! single type. This is a deliberate byte-identical mirror of the definition in
//! `rclip-url-file`, which is where the family's canonical copy currently
//! lives; codec crates in this workspace do not depend on each other, so the
